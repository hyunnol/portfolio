				...
				<div class="sel">
					<div class="row1">
						<ul class="list-theme1">
							<li><a href="list/cate?='로맨스/멜로'">로맨스/멜로</a></li>
							<li><a href="list/cate?='스릴러/공포/느와르'">스릴러/공포/느와르</a></li>
							<li><a href="list/cate?='가족/코미디'">가족/코미디</a></li>
						</ul>
					</div>
					<div class="row2">
						<ul class="list-theme2">
							<li><a href="list/cate?='액션/SF'">액션/SF</a></li>
							<li><a href="list/cate?='애니메이션'">애니메이션</a></li>
							<li><a href="list/cate?='역사/다큐'">역사/다큐</a></li>
						</ul>
					</div>
				</div>
			</div>
